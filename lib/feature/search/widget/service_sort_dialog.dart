      ...
      return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          AppRadioGroup<String>(
            selected: searchController.selectedSortByType,
            onChanged: (val) {
              if (val != null) {
                searchController.updateSortByType(val);
              }
            },
            child: ListView.builder(itemBuilder: (context,index){
              final value = searchController.sortByType[index];
              return AppRadioListTile<String>(
              visualDensity: VisualDensity.compact,
              dense: true,
              contentPadding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
              activeColor: Theme.of(context).colorScheme.primary,
              title: Text(value.tr ,style: robotoRegular.copyWith(
                  fontSize: Dimensions.fontSizeDefault,
                  color: Theme.of(context).textTheme.bodyMedium?.color
              )),
              value: value,
