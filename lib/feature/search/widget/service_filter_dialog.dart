                ...
                child: Padding(padding: EdgeInsets.symmetric(horizontal: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeDefault : 0),
                  child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start,children: [
                    ...
                    AppRadioGroup<String>(
                      selected: searchController.selectedRating,
                      onChanged: (val) {
                        if (val != null) {
                          searchController.updateFilterByRating(val);
                        }
                      },
                      child: ListView.builder(itemBuilder: (context,index){
                        final value = searchController.ratingFilter[index];
                        return SizedBox(
                          height: 35,
