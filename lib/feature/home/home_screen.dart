...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget homeAppBar({GlobalKey<CustomShakingWidgetState>? signInShakeKey}){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(preferredSize: const Size.fromHeight(70), child: homeAppBar(signInShakeKey: signInShakeKey)),
