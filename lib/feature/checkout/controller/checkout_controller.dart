...
class CheckOutController extends GetxController implements GetxService{
 ...
 Future<void> placeBookingRequest({
  ...
  // Avoid relying on server message for localization; use stable app key instead
  customSnackBar('your_booking_has_been_placed_successfully'.tr, type: ToasterMessageType.success, margin: 55);
