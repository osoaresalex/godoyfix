                ...
                <div class="col-12">
                    ...
                    <div class="bg-warning bg-opacity-10 fs-12 p-12 text-dark rounded mb-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <p class="fz-12 mb-20">{{ translate('Setup Push Notification Messages for customer. Must setup') }} <a href="{{ route('admin.configuration.third-party','firebase-configuration') }}" target="_blank" class="text-primary text-decoration-underline fw-medium">{{ translate('Firebase Configuration') }}</a> {{ translate(' page to work notifications.') }}</p>
                        </div>
                    </div>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="bg-light rounded p-20">
                                                <div class="message-textarea">
                                                    ...
                                                    <textarea class="form-control block-size-initial" name="title" rows="1" placeholder="Type title" data-maxlength="100" maxlength="100"></textarea>
                                                ...
                                                <div class="message-textarea">
                                                    ...
                                                    <textarea class="form-control block-size-initial" name="description" rows="1" placeholder="Type about the description" data-maxlength="200" maxlength="200"></textarea>
                                                    <div class="d-flex justify-content-end mt-1">
                                                ...
                                                <div class="row g-sm-4 g-3">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="position-relative collpse-icon">
                                                            ...
                                                            <span class="material-symbols-outlined position-absolute end-0 px-2 down-icon">
                                                                keyboard_arrow_down
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center bg-light rounded p-20 h-100">
                                                <div class="boxe py-sm-4 py-2">
                                                    <div class="mb-4 text-center">
                                                        ...
                                                        <p class="fz-12">Upload your cover Image</p>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-end gap-20">
                                                ...
                                                <button class="btn btn--primary rounded demo_check"
                                                        type="submit">{{translate('Save & Send')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center gap-3 h-full">
                                                @can('push_notification_export')
                                                    <div class="dropdown h-100">
                                                        <button type="button"
                                                                class="btn btn--secondary block-size-36 rounded text-capitalize dropdown-toggle"
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                @can('push_notification_delete')
                                                                    ...
                                                                    <form action="{{route('admin.push-notification.delete',[$item->id])}}"
