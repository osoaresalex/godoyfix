...
//        $route = '#';
//        if ($page->page_key == 'about_us') {
//            $route = route('page.about-us');
//        } elseif ($page->page_key == 'cancellation_policy') {
//            $route = route('page.cancellation-policy');
//        } elseif ($page->page_key == 'privacy_policy') {
//            $route = route('page.privacy-policy');
//        } elseif ($page->page_key == 'refund_policy') {
//            $route = route('page.refund-policy');
//        } elseif ($page->page_key == 'terms_and_conditions') {
//            $route = route('page.terms-and-conditions');
//        }else{
//            $route = route('page.dynamic', ['slug' => $page->page_key]);
//        }
