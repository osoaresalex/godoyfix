                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-business phone-picker-wrap">
                                                                    ...
                                                                    <input type="tel" class="form-control company_phone phone-input-with-country-picker99 iti__tel-input"
                                                                           name="company_phone"
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" class="country-picker-phone-number99 w-50" value="{{old('company_phone')}}" name="company_phone" hidden  readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
...
{{--                                                            <div class="col-md-12">--}}
{{--                                                                <div class="business-map border rounded-1 overflow-hidden">--}}
{{--                                                                    <iframe class="w-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d52799460.8901892!2d-161.43363246955474!3d36.12703303279309!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e0!3m2!1sen!2sbd!4v1744537371972!5m2!1sen!2sbd" height="157" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>--}}
{{--                                                                </div>--}}
{{--                                                            </div>--}}
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-center gap-1 bg-primary bg-opacity-10">
                                                ...
                                                <p class="fz-12">For the address setup you can simply drag the map to pick for the perfect <span class="fw-semibold">Lat(Latitude) & Log(Longitude)</span> value.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="form-business">
                                                    ...
                                                    <input type="tel"
                                                           oninput="this.value = this.value.replace(/[^+\d]+$/g, '').replace(/(\..*)\./g, '$1');"
                                                           class="form-control company_phone phone-input-with-country-picker100 iti__tel-input"
                                                           name="contact_person_phone"
                                                           id="contact_person_phone"
                                                           value="{{ $provider->contact_person_phone }}"
                                                           placeholder="{{translate('Phone')}}" required>
                                                    <div class="">
                                                        <input type="text" class="country-picker-phone-number100 w-50" value="{{old('contact_person_phone')}}"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade {{$webPage=='bookings'?'active show':''}}">
                                ...
                                <form action="{{route('provider.business-settings.set-business-information')}}" method="POST">
                                    ...
                                    <div class="card card-body mb-3">
                                        <div class="mb-4">
                                            <h3 class="mb-1">Booking Request Setup</h3>
                                            <p class="fz-12 mb-0">Here you can setup for service man where they want to cancel or edit bookings.</p>
                                        </div>
                                        <div class="card card-body bg-light shadow-none mb-3">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-lg-8">
                                                    <div>
                                                        <h4 class="mb-1">Cancel Booking Request</h4>
                                                        <p class="fz-12 mb-0">By turning the switch service men can cancel booking</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card card-body bg-light shadow-none mb-3">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-lg-8">
                                                    <div>
                                                        <h4 class="mb-1">Edit Booking Request</h4>
                                                        <p class="fz-12 mb-0">By turning the switch service men can edit booking</p>
                                                    </div>
                                                </div>
                                    ...
                                    @if($serviceAtProviderPlace)
                                        <div class="card card-body">
                                            <div class="mb-4">
                                                <h3 class="mb-1">Service Location</h3>
                                                <p class="fz-12 mb-0">Here you setup where you want to provide services at your business location or customer location.</p>
                                            </div>
                                            <div class="card card-body bg-light shadow-none">
                                                <div class="d-flex gap-3 justify-content-between align-items-center flex-wrap">
                                                    <div class="flex-grow-1 d-flex gap-2 align-items-start">
                                                        ...
                                                        <div class="form-check-label">
                                                            <h5 class="opacity-75">Customer Location</h5>
                                                            <p class="fs-12 mb-0">By checking this option you will be able to provide service at customer location</p>
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 d-flex gap-2 align-items-start">
                                                        ...
                                                        <div class="form-check-label">
                                                            <h5 class="opacity-75">My Location</h5>
                                                            <p class="fs-12 mb-0">By checking this option you will be able to provide service at your business location</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $('#same_as_business_info').on('change', function () {
            if ($(this).is(':checked')) {
                ...
                $('[name="contact_person_email"]').val($('[name="company_email"]').val());
                ...
                $('.country-picker-phone-number100').val(fullPhoneNumber);

                $('.country-picker-2 .iti__selected-dial-code').text(dialCode);
                $('.country-picker-2 .iti__selected-flag .iti__flag')
                    .attr('class', $('.country-picker-1 .iti__selected-flag .iti__flag').attr('class'));

            } else {
                $('[name="contact_person_name"]').val('');
                $('[name="contact_person_email"]').val('');
                $('#contact_person_phone').val('');
                $('.country-picker-phone-number100').val('');
            }
        });
