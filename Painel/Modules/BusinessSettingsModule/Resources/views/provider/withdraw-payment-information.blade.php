                                                            ...
                                                            <ul class="dropdown-menu cus-shadow2 py-3 dropdown-menu-right">
                                                                @if($method->is_default == 0)
                                                                    <a href="{{ route('provider.settings.payment-information.default-status-update', [$method->id])}}" class="dropdown-item mb-1 d-flex align-items-center gap-2 fz-14 text-dark" type="button">
                                                                        <i class="fi fi-rr-clock-three"></i> Mark As Default
                                                                    </a>
                                                                @endif
                                                                ...
                                                                @if($method->is_default == 0)
{{--                                                                    <button type="button" class="dropdown-item d-flex align-items-center gap-2 fz-14 text-dark form-alert"--}}
...
{{--                                                                    </button>--}}
                                                                        ...
                                                                        <button type="button"
                                                                                ...
                                                                                data-id="delete-{{$method->id}}"
                                                                                data-title="{{ translate('Delete Confirmation') }}"
                                                                                data-message="{{ translate('want_to_delete_this') }}?"
                                                                                data-action="delete">
...
{{--                                                                method="post" id="delete-{{$method->id}}" class="hidden">--}}
{{--                                                                @csrf--}}
{{--                                                                @method('DELETE')--}}
{{--                                                            </form>--}}
