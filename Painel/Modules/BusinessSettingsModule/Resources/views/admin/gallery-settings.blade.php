    ...
    <div class="content container-fluid">
        ...
        @if($storage == 'local')
            <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-center gap-1 bg-primary bg-opacity-10 mb-20">
                ...
                <p class="fz-12">{{ translate('Currently you are using local storage, if you want to use 3rd party storage, need to setup connection with') }} <a href="{{ route('admin.configuration.third-party', 'storage_connection') }}" target="_blank" class="fw-semibold text-primary text-decoration-underline">{{ translate('3rd Party Storage') }}</a></p>
            </div>
        @endif
