                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switcher" data-bs-toggle="modal" data-bs-target="#deactivateAlertModal">
                                            <input class="switcher_input route-alert" type="checkbox"
                                                   data-route="{{route('admin.social-media.status', [$item['id']])}}"
                        ...
                        <form action="" method="post">
                            ...
                            <div class="choose-option">
                                <div class="d-flex gap-3 justify-content-center flex-wrap">
                                    ...
                                    <button type="submit" class="btn px-xl-5 px-4 btn--danger text-capitalize rounded">Yes, Delete</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.edit-social-media', function () {
                ...
                offcanvas.find('#edit-media').val(media).trigger('change');
                offcanvas.find('#edit-link').val(link);
            });
