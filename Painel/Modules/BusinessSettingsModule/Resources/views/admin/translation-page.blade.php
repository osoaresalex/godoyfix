            ...
            <div class="card mt-3">
                ...
                <div class="bg-warning bg-opacity-10 fs-12 p-12 text-dark rounded mb-20">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <p class="fz-12">After change or type Translated Value or click Auto Translate button, make sure you click Save Button.</p>
                    </div>
                </div>
                    <div class="data-table-top d-flex align-items-center flex-wrap gap-2 justify-content-between mb-0">
                        <h5 class="text-dark fw-semibold">Language Content Table</h5>
