                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <!-- <div>
                            <i class="material-icons" data-bs-toggle="tooltip" data-bs-placement="top"
                               title="{{translate('Please click save information for making the changes')}}"
                            >info</i>
                        </div> -->
                    </div>
                                                    ...
                                                    <div class="d-flex gap-sm-2 gap-2 align-items-start">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="fz-12 max-w-500">
                                                                ...
                                                                <a href="{{ route('admin.configuration.third-party', ['webPage' => 'payment_config', 'type' => 'digital_payment']) }}" class="fw-semibold text-primary text-decoration-underline">{{ translate('click here') }}</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="d-flex gap-sm-2 gap-2 align-items-start">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="fz-12 max-w-500">
                                                                ...
                                                                <a href="{{ route('admin.configuration.third-party', ['type' => 'offline_payment', 'webPage' => 'payment_config']) }}" class="fw-semibold text-primary text-decoration-underline">{{ translate('click here') }}</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card p-20 mb-20">
                                        ...
                                        <div class="bg-warning bg-opacity-10 fs-12 p-12 text-dark rounded mb-3">
                                            ...
                                            <ul class="m-0 ps-20 d-flex flex-column gap-1 text-dark">
                                                <li>{{ translate('Customer wallet from the') }} <a href="{{ route('admin.business-settings.get-business-information', ['web_page' => 'customers']) }}" class="fw-semibold text-primary text-decoration-underline">{{ translate('Customer Wallet') }}</a> {{ translate('page') }}</li>
                                    ...
                                    <div class="card p-20 mb-20">
                                        ...
                                        <div class="card2 p-20">
                                            ...
                                            <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-start gap-1 bg-primary bg-opacity-10">
                                                ...
                                                <p class="fz-12">{{ translate('You can see all the inactive providers who are suspended from') }} <a href="{{route('admin.provider.list', ['status'=>'all'])}}" class="text-primary text-decoration-underline fw-medium">{{ translate('Provider List') }}</a> {{ translate('page.') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card p-20 mb-20">
                                        ...
                                        <div class="card2 p-20">
                                            ...
                                            <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-start gap-1 bg-primary bg-opacity-10">
                                                ...
                                                <p class="fz-12">{{ translate('All the provider') }} <a href="{{ route('admin.withdraw.request.list', ['status'=>'all']) }}" class="text-primary text-decoration-underline fw-medium">{{ translate('Withdraw Request') }}</a> {{ translate('you wil find from Withdraw Request page. For further setup for withdraw request go to') }} <a href="{{ route('admin.withdraw.method.list') }}" class="text-primary text-decoration-underline fw-medium">{{ translate('Withdraw Method Setup') }}</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end trans3 mt-4">
                                ...
                                <form action="{{route('admin.business-settings.set-promotion-setup')}}"
                                    ...
                                    <div class="card p-20 mb-20">
                                        ...
                                        <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-center gap-1 bg-primary bg-opacity-10">
                                            ...
                                            <p class="fz-12">{{ translate('You can manage your normal discount from here') }} <a href="{{ route('admin.discount.list') }}" class="text-primary fw-medium text-underline">{{ translate('Normal Discount') }}</a></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card p-20 mb-20">
                                        ...
                                        <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-center gap-1 bg-primary bg-opacity-10">
                                            ...
                                            <p class="fz-12">{{ translate('You can manage your campaign discount from here') }} <a href="{{ route('admin.campaign.list') }}" class="text-primary fw-medium text-underline">{{ translate('Campaign Discount') }}</a></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card p-20 mb-20">
                                        ...
                                        <div class="pick-map p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-center gap-1 bg-primary bg-opacity-10">
                                            ...
                                            <p class="fz-12">{{ translate('You can manage your coupon discount from here') }} <a href="{{ route('admin.coupon.list') }}" class="text-primary fw-medium text-underline">{{ translate('Coupon Discount') }}</a></p>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="d-flex flex-sm-nowrap flex-wrap gap-sm-3 gap-2 align-items-start">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="pick-map p-12 rounded bg-warning bg-opacity-10 d-flex flex-md-nowrap flex-wrap align-items-start gap-1">
                                                                    ...
                                                                    <p class="fz-12">{{ translate('To active subscription based business model first you need to add subscription package from') }} <a href="{{ route('admin.subscription.package.list') }}" class="fw-semibold text-primary text-decoration-underline">{{ translate('Subscription Packages') }}</a></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
