    ...
    <div class="tab-content">
        <div class="tab-pane fade show active"
            ...
            <div class="pick-map mb-3 p-12 rounded d-flex flex-md-nowrap flex-wrap align-items-center gap-1 bg-primary bg-opacity-10">
                ...
                <p class="fz-12">{{ translate('This SMS gateway will work for') }} <a href="{{ route('admin.business-settings.login.setup') }}" class="text-primary fw-semibold text-decoration-underline"> {{ translate('OTP verification') }} </a> {{ translate('_or') }} <a href="{{ route('admin.configuration.third-party', 'firebase-authentication') }}" class="text-primary fw-semibold text-decoration-underline">{{ translate('Notification') }}</a> {{ translate('_through SMS.') }}</p>
            </div>
...
{{--                                    <button type="button"--}}
{{--                                            @if(!($data['firebase_otp_verification']['live_values']['status'] == 1 || count(collect($data['gateways'])->where('is_active', 1)) > 0))--}}
{{--                                                class="pointer-events-none rounded transition text-nowrap fz-12 fw-semibold btn-primary__outline btn d-flex align-items-center gap-1 py-2 px-3"--}}
...
{{--                                                data-bs-toggle="modal" data-bs-target="#send__sms"--}}
{{--                                            @endif>--}}
{{--                                        <img src="{{ asset('public/assets/admin-module/img/icons/send-icon.svg') }}"--}}
{{--                                             alt="send icon" class="svg">--}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="custom-radio">
                                                ...
                                                <label for="radio-option-2">
                                                    ...
                                                    <p class="fz-12 max-w-250">{{translate('Setup necessary')}} <a href="{{ route('admin.configuration.third-party', 'firebase-configuration') }}" class="text-primary text-decoration-underline">Firebase Configurations.</a></p>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="mb-0">
                                                    <label class="switcher">
                                                        <input type="checkbox"
                                                               ...
                                                               class="{{ env('APP_ENV') == 'demo' ? '' : 'update-status-modal' }} switcher_input {{ $smsConfig['key_name'] }}"
                    ...
                    <form action="javascript:" class="body-bg rounded p-20">
                        ...
                        <div class="d-flex align-items-center gap-1 iti__custom">
                            <!-- <input type="email"class="form-control" id="test-email"  name="email" placeholder="{{translate('+880 Ex: abc@email.com')}}" required="" value="{{old('email')}}"> -->
                             <input type="tel"  class="form-control phone-input-with-country-picker" id="exampleInputPhone" name="phone" placeholder="{{translate('Phone_number')}}" value="" required>
                                <div class="">
                                    <input type="text"  class="country-picker-phone-number w-50" value="{{old('phone')}}" name="phone" hidden
                                            readonly>
                                </div>
                            <div class="">
