                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="body-bg rounded p-20">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" name="download_link_for_android" placeholder="{{translate('Download Url')}} *" required="" value="{{$data['customer_app_settings']['download_link_for_android'] ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="body-bg rounded p-20">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" name="download_link_for_ios" placeholder="{{translate('Download Url')}} *" required="" value="{{$data['customer_app_settings']['download_link_for_ios'] ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="body-bg rounded p-20">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" name="download_link_for_android" placeholder="{{translate('Download Url')}} *" required="" value="{{$data['provider_app_settings']['download_link_for_android'] ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="body-bg rounded p-20">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" name="download_link_for_ios" placeholder="{{translate('Download Url')}} *" required="" value="{{$data['provider_app_settings']['download_link_for_ios'] ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="body-bg rounded p-20">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" name="download_link_for_android" placeholder="{{translate('Download Url')}} *" required="" value="{{$data['serviceman_app_settings']['download_link_for_android'] ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="body-bg rounded p-20">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" name="download_link_for_ios" placeholder="{{translate('Download Url')}} *" required="" value="{{$data['serviceman_app_settings']['download_link_for_ios'] ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
