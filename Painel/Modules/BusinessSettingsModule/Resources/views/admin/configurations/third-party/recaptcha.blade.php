@if($webPage == 'recaptcha')
                ...
                <div class="card">
                    <div class="card-body p-20">
                        <div
                            ...
                            <div
                                class="d-flex justify-content-between align-items-center px-3 py-lg-3 py-2">
                        ...
                        <div class="discount-type body-bg rounded p-20 mb-20">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="">
                                        <label
                                            class="mb-2 text-dark d-flex align-items-center gap-1">{{translate('Secret Key')}}
                                            <i class="material-icons fz-14 text-light-gray" data-bs-toggle="tooltip"
                                               data-bs-placement="top"
    ...
    <div class="modal fade" id="recaptcha-how-to-get-credentials" tabindex="-1"
         aria-hidden="true">
