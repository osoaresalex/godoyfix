...
class ProviderController extends Controller
{
    ...
    public function searchRouting(Request $request):JsonResponse
    {
        ...
        $formattedRoutes = $this->advanceSearchService->pageSearchList($searchKeyword,"provider");
        $menuSearchResults = [];
        if (!empty($searchKeyword)) {
            $menuSearchResults = $this->advanceSearchService->searchMenuList($searchKeyword,"provider");
        }
        $modelSearchResults = $this->advanceSearchService->searchModelList($searchKeyword, "provider");
