...
<head>
    ...
    {{-- TEST: Hardcoded favicon to test cache --}}
    <link rel="shortcut icon" href="{{ asset('assets/admin-module/img/placeholder.png') }}"/>
    ...
    <form action="{{route('admin.auth.login')}}" enctype="multipart/form-data" method="POST"
        ...
        <div class="login-wrap">
            ...
            <div class="login-right-wrap bg-white">
                ...
                @if(env('APP_ENV')=='demo')
                    <div class="login-footer d-flex justify-content-between c1-bg text-white gap-3">
