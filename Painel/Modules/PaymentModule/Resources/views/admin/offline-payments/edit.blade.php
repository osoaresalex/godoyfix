                        ...
                        <div class="d-flex align-items-center justify-content-between flex-sm-nowrap flex-wrap gap-3 mb-20">
                            <div>
                                ...
                                <a href="{{ route('admin.configuration.third-party', ['webPage' => 'payment_config', 'type' => 'offline_payment'] ) }}" class="d-flex align-items-center gap-2 text-primary fz-14">
                                    <i class="material-symbols-outlined">arrow_back</i> Back to Offline Payment Methods
                                </a>
                            </div>
                            <button type="button" class="rounded transition text-nowrap fz-12 fw-semibold btn-primary__outline btn d-flex align-items-center gap-1 py-2 px-3" data-bs-toggle="offcanvas" data-bs-target="#offline-offcanvas_preview">
                                <span class="material-symbols-outlined">visibility</span> Section View
                            </button>
                        </div>
                                                ...
                                                @if($key>=0 && $field['field_name'] != 'payment_note')
                                                    <div id="field-row-customer--{{ $randId }}" class="field-row-customer body-bg rounded p-20 position-relative">
                                                        <div class="row gy-3 align-items-center">
                                                            <div class="col-md-4">
                                                                <div class="">
                                                                    <div class="mb-2 text-dark d-flex align-items-center gap-1">Input field name
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="">
                                                                    <div class="mb-2 text-dark d-flex align-items-center gap-1">Placeholder
                                                                    </div>
                                                            ...
                                                            <span class="btn btn--danger position-absolute top-0 end-3 w-30 h-30 p-0 remove-field-btn rounded-1 d-center" data-counter="{{ $randId }}">
                                                                <i class="material-symbols-outlined m-0 fz-20">delete</i>
                                                            </span>
                                                        </div>
                                                    </div>
                ...
                <div class="max-w-300 mx-auto">
                    ...
                    <div class="body-bg rounded p-16 d-flex flex-column gap-4">
                        ...
                        <div>
                            ...
                            <textarea type="text" class="form-control" name="" placeholder="Ex : Lorem ipsum dolor sit amet, consectetu" required="" readonly rows="5"></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            $('#add-more-field-customer').on('click', function (event) {
                ...
                <span class="btn btn--danger position-absolute top-0 end-3 w-30 h-30 p-0 remove-field-btn rounded-1 d-center" data-counter="${counter}">
                                        <i class="material-symbols-outlined m-0 fz-20">delete</i>
                                    </span>
                                </div>
                        </div>`
