...
<aside class="aside">
    ...
    <div class="aside-body" data-trigger="scrollbar">
        ...
        <ul class="nav">
            ...
            @canany(['discount_view', 'discount_add', 'coupon_view', 'coupon_add', 'bonus_view', 'bonus_add', 'campaign_view', 'campaign_add','advertisement_view', 'advertisement_add', 'banner_add' ])
            ...
            @canany(['push_notification_view','push_notification_add' ])
        ...
        @canany(['provider_view', 'provider_add', 'provider_approve_or_deny','withdraw_view', 'withdraw_add'])
            ...
            @can(['transaction_view', 'report_view','analytics_view'])
            ...
            @canany(['configuration_view'])
                ...
                <li>
                    <a href="{{ route('admin.configuration.third-party', 'map-api') }}"
                       class="{{ request()->is('admin/configuration/third-party/*')
