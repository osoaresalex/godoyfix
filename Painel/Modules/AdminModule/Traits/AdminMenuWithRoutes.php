    ...
    public function adminMenuWithRoutes()
    {
        $result = [
            ...
            [
                ...
                "keywords" => 'verify request, Bookings',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'Booking Request, Bookings',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'offline Payment List, Bookings',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Accepted',
            ...
            [
                ...
                "keywords" => 'service list, Services',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'New Service Requests, Services',
                "type" => 'menu',
            ],
            [
                ...
                'keywords' => 'Customer List, Customers',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'add new customer, Customers',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'Transaction Reports, Reports',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'Business Reports, Reports',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'Booking Reports, Reports',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'Provider Reports, Reports',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                'full_route' => url('admin/business-settings/get-business-information?web_page=payment'),
                "page_title" => 'Payment',
                "keywords" => 'Payment',
                "type" => 'menu',
            ],
            [
                ...
                'full_route' => url('admin/business-settings/get-business-information?web_page=providers'),
            ...
            [
                ...
                'full_route' => url('admin/business-settings/get-business-information?web_page=customers'),
                "page_title" => 'Customers',
                "keywords" => 'Customers',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Serviceman',
                'uri' => 'admin/business-settings/get-business-information?web_page=servicemen',
                'full_route' => url('admin/business-settings/get-business-information?web_page=servicemen'),
                "page_title" => 'Serviceman',
                "keywords" => 'Serviceman, Service Man',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Promotions',
                'uri' => 'admin/business-settings/get-business-information?web_page=promotional_setup',
                'full_route' => url('admin/business-settings/get-business-information?web_page=promotional_setup'),
                "page_title" => 'Promotions',
                "keywords" => 'Promotions',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Business_Plan',
            ...
            [
                ...
                'full_route' => url('admin/business-settings/notification-channel?notification_type=provider'),
                "page_title" => 'Provider',
                "keywords" => 'Provider',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Service Man',
                'uri' => 'admin/business-settings/notification-channel?notification_type=serviceman',
                'full_route' => url('admin/business-settings/notification-channel?notification_type=serviceman'),
                "page_title" => 'Serviceman',
                "keywords" => 'Serviceman, Service Man',
                "type" => 'menu',
            ],
            ...
            [
                ...
                'full_route' => url('admin/configuration/get-notification-setting?type=serviceman'),
                "page_title" => 'Serviceman',
                "keywords" => 'Serviceman',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Old_3rd_party',
                'uri' => 'admin/configuration/get-third-party-config?web_page=google_map',
                'full_route' => url('admin/configuration/get-third-party-config?web_page=google_map'),
                "page_title" => 'Old_3rd_party',
                "keywords" => 'Old 3rd party, Configuration',
                "type" => 'menu',
            ],
            [
                'route_name' => '3rd_party',
                'uri' => 'admin/configuration/third-party/map-apip',
                'full_route' => url('admin/configuration/third-party/map-api'),
                "page_title" => '3rd_party',
                "keywords" => '3rd party, Configuration',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Firebase',
            ...
            [
                ...
                "page_title" => 'Payment_config',
                "keywords" => 'Payment config',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'Business pages, Pages & media',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Social_media',
                ...
                "page_title" => 'Social_media',
                "keywords" => 'Social media, Pages & media',
                "type" => 'menu',
            ],
            [
                'route_name' => 'Gallery',
