    ...
    public function getAdminModels(): array
    {
        return [
            'providers' => [
                ...
                'routes' => ['admin/provider/details/{id}?web_page=overview&provider={id}','admin/provider/edit/{id}'],
            ...
            'users' => [
                ...
                'routes' => ['admin/customer/list','admin/customer/edit/{id}','admin/employee/list','admin/customer/detail/{id}?web_page=overview'],
                'access_type' => ['admin', 'vendor']
            ],
            'bookings' => [
            ...
            // position check, based on position route will dynamically added here,
            'categories' => [
